 ...
 * @author SENJU
 */
public class pretestnew extends javax.swing.JFrame {

    /**
     * Creates new form pretestnew
     */
    public pretestnew() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("PENCATAT NILAI MAHASISWA");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(pretestnew.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new pretestnew().setVisible(true);
            }
        });
    }
